...
export const KH_CONFIG: CountryConfig = {
  ...
  hosts: {
    order: process.env.BASE_URL || 'https://stg.kh.buymed.tech',
    ...
    app: process.env.APP_URL || 'https://api.stg.kh.buymed.tech',
  },
  ...
  delivery: {
    ...
    carrierId: 2,
    carrierName: 'Internal Carrier Thai',
    clientId: process.env.DELIVERY_CLIENT_ID || 'flPzDwKw26hnrCAa7JB4DbSbqCL2ShXxf8kY5rvYYKX6Fjqv',
    clientSecret: process.env.DELIVERY_CLIENT_SECRET || 'YflZe6YN2xqw7UHGY2vDIPa6sdZ1HIL1RtwVptv9wdgjPYPz',
